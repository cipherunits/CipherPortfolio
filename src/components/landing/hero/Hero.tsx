...
export default function Hero() {
  return (
    <section
      className="flex md:flex-row flex-col gap-10 items-center justify-between max-w-6xl p-6 mx-auto pt-12"
      aria-labelledby="hero-heading"
    >
      <div className="max-w-lg space-y-6">
        <h1
          id="hero-heading"
          className="font-semibold text-[34px] text-white leading-tight"
        >
          Building{" "}
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="border border-(--color-stroke) px-2 flex items-center gap-2 py-1 w-[80%]">
          <span className="bg-(--color-primery) p-1.5" aria-hidden />
