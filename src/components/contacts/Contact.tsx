  ...
  return (
    <div className="max-w-6xl mx-auto p-6 mt-12">
        ...
        <div className="flex md:flex-row flex-col gap-10 items-center justify-between ">
            <p className="w-md font-medium [word-spacing:6px] md:px-0 px-8 md:text-start text-center text-(--color-stroke)">IGet in touch with CipherUnit for collaborations, contributions, or any technical inquiries. We’re always open to new ideas and partnerships.</p>
